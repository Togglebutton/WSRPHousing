...
return {
	 ...
	 },
	{
		...
		owner = "Neffelo Clamp",
		hours = "Wednesdays 10pm est - 1am",
		staff = "Neffelo Clamp, Chef Noriack, Vannyx Xanniton, Priestess Helmina",
		description = "The premier Club Casino and Bar! It hosts beverages from Bezgelore and a wide assortment of safe for all to consume beverages as well. Come try your hand at the slot machines or some cards or roulette while you're there. Meet some new friends and get immersed in chua culture!\nCome and marvel at the technology displayed! Admired the scientific beauty! Make new contacts for business! All at the Shock Collar Bar and Casino!\nThis club is run by the Red Tail Collective headed by Neffelo Clamp and is open to all. A small section that is a chua only private bar inside the main building exists for those chua needing to get to a place that feels more like home.",
	 },
	 {
		title = "The Eldan Fried Cubig Protobar",
		owner = "Grumlen Dangerpants",
		hours = "24/7",
