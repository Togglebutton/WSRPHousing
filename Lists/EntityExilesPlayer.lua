...
return {
	{ 
		title = "Hayboria",
		 ...
		 screenshots = "EntityExilesPlayer:SriNutmoon1, EntityExilesPlayer:SriNutmoon2"
	},
	{
		title = "Hoogles!", 
		...
		screenshots = "EntityExilesPlayer:BoomerBoomhowl1, EntityExilesPlayer:BoomerBoomhowl2"
	},
	{
		title = "Dead End", 
		owner = "Grayson Nash", 
	...
	{
		title = "Penitence Departed ",
		owner = "Bolivar Venko",
		hours = "24/7",
		staff = "Bolivar Venko, Breir Blueleaf",
		description = "\"Penitence Departed\" is a Dominion research vessel available on Exile side for use in RP plots and events. It features an engine room, test chamber, laboratory, cell block, medbay, crew quarters, and bridge. The plot is public 24/7. Please message Breir Blueleaf with any questions or requests. ",
	},
}